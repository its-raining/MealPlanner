...
/**
 * This class represents the back-end for managing all operations associated
 * with the foodItems in a meal
 * 
...
public class MealData {
	...
	/**
	 * The method analyzes nutrients of the FoodItems within this MealData. It then
	 * returns the total values for each nutrient
	 * 
